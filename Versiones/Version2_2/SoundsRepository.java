...
public class SoundsRepository {
	...
	// Almacén de sonidos, se trata de un HashMap que tiene String como "claves" de
	// los objetos y "AudioClip" como objetos
	...
	public static String BOLA = "Arkanoid-SFX-01.wav";
	...
	/**
	 * Obtiene el AudioClip desde el almacén HashMap, si no existe lo carga desde el
	 * disco duro.
	 * 
	 * @param resourceName
	 * @return
	...
	private AudioClip getAudioClip(String resourceName) {
		// En primera instancia intentamos obtener el objeto AudioClip a partir del
		// HashMap.
		AudioClip clip = sounds.get(resourceName);

		// En caso de que el objeto AudioClip no exista dentro del HashMap, se carga
		// desde el disco duro
		if (clip == null) {
